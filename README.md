...
**构建号**：10012。安装包请从 [Releases](https://github.com/jia070310/lomenTV-VDS/releases) 下载；仓库内不再附带 APK 二进制。
...
**构建与文档**：`versionName` / `versionCode` 更新为 **1.0.12 / 10012**；本段为相对 1.0.11 的变更说明。
