...
**构建号**：10013。安装包请从 [Releases](https://github.com/jia070310/lomenTV-VDS/releases) 下载；仓库内不再附带 APK 二进制。
...
- **其他**：启动图/主题与部分弹窗尺寸、TMDB/媒体同步与直播相关界面等同期迭代，详见本次提交变更文件。
