package com.lomen.tv.ui.live.utils
 ...
 * 处理 TV 遥控器按键事件
 */
fun Modifier.handleLiveKeyEvents(
...
fun Modifier.handleLiveKeyEvents(
    ...
    onKeyTap = mapOf(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
            this[KeyEvent.KEYCODE_SYSTEM_NAVIGATION_LEFT] = onLeft
            this[KeyEvent.KEYCODE_SYSTEM_NAVIGATION_RIGHT] = onRight
            this[KeyEvent.KEYCODE_SYSTEM_NAVIGATION_UP] = onUp
            this[KeyEvent.KEYCODE_SYSTEM_NAVIGATION_DOWN] = onDown
        }
    },
    onKeyLongTap = mapOf(
 ...
 * 处理滑动手势
 */
fun Modifier.handleLiveDragGestures(
    onSwipeUp: () -> Unit = {},
    onSwipeDown: () -> Unit = {},
    onSwipeLeft: () -> Unit = {},
    onSwipeRight: () -> Unit = {},
 ...
 * 处理用户操作（用于自动关闭面板）
 */
fun Modifier.handleLiveUserAction(onHandle: () -> Unit) =
